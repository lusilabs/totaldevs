    ...
    <div className='bg-white shadow overflow-hidden sm:rounded-lg m-4'>
      <div className='px-4 py-5 sm:px-6'>
        <div className='flex flex-row justify-between items-center'>
          <div>
            {userDoc.role === 'dev' && <>
              <h3 className='text-lg leading-6 font-medium text-gray-900'>(this is what others will see)</h3>
                                       </>}
            {userDoc.role !== 'dev' && <>
          ...
          <div>
            <button
              className='text-yellow-500 px-4 w-auto h-10 bg-yellow-500 rounded-full hover:bg-gray-700 active:shadow-lg mouse shadow transition ease-in duration-200 focus:outline-none'
            >
              ...
              <span className='text-white' onClick={() => setIsEditing(true)}>edit</span>
            </button>
          </div>
        </div>
      </div>
