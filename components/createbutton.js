...
export default function CreateButton ({ text = 'new' }) {
  return (
    <button
      className='text-white px-4 w-auto h-12 bg-indigo-500 rounded-full hover:bg-indigo-700 active:shadow-lg mouse shadow transition ease-in duration-200 focus:outline-none'
    >
