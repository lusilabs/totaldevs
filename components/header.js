          ...
          <>
            <div className='max-w-full mx-auto px-2 sm:px-4 lg:px-8'>
              <div className='flex items-center justify-between h-16'>
                    ...
                    <Menu as='div' className='ml-3 relative'>
                      <div>
                        <Menu.Button className='max-w-xs bg-gray-800 rounded-full flex items-center text-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white'>
                          ...
                          <img className='h-8 w-8 rounded-full' src={mocked.img} alt='' />
                        </Menu.Button>
                      </div>
                      <Transition
                        as={Fragment}
                ...
                <div className='-mr-2 flex hidden md:hidden'>
                  {/* Mobile menu button */}
                  <Disclosure.Button
            ...
            <Disclosure.Panel className='lg:hidden'>
              ...
              <div className='pt-4 pb-3 border-t border-gray-700'>
                <div className='flex items-center px-5'>
                  <div className='flex-shrink-0'>
                    {/* <img className='h-10 w-10 rounded-full' src={user?.photoURL ?? mocked.img} alt='' /> */}
                    <img className='h-10 w-10 rounded-full' src={mocked.img} alt='' />
                  </div>
                  <div className='ml-3'>
