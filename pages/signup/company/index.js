...
function AddJob ({ userDoc, jobID, ...props }) {
  ...
  //   const { sid, shopID } = router.query
  //   useEffect(() => {
  //     const fetchJobDoc = async () => {
  ...
  return (
    <div className='m-4 md:col-span-2 shadow-xl'>
      <h3 className='text-gray-500'>post your open position for free.</h3>
        ...
        <div className='shadow overflow-hidden rounded-lg'>
          <div className='px-4 py-5 bg-white sm:p-6'>
            <div className='grid grid-cols-6 gap-6'>
              ...
              <div className='col-span-6 sm:col-span-3'>
                ...
                {errors.salary && <div className='m-2 text-sm text-red-500'>salary cannot be null</div>}
              </div>
                  ...
                  <div className='w-0 flex-1 flex items-center'>
                    {pdfName && <> <svg className='flex-shrink-0 h-5 w-5 text-gray-400' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 20 20' fill='currentColor' aria-hidden='true'>
                      ...
                      <div className='ml-4 flex-shrink-0'>
                        <a href={pdfURL} className='font-medium text-indigo-600 hover:text-indigo-500' download={pdfName}>
                          download
                        </a>
                      </div>
                                </>}
          ...
          <div className='px-4 py-3 bg-gray-50 text-right sm:px-6 mb-8'>
            <Button disabled={saving} loading={saving} type='submit' color='green' fluid className='text-md'>
              ...
              {!saving && <span>post</span>}
            </Button>
            &nbsp;
            <Button disabled={saving} loading={saving} type='submit' color='gray' fluid className='text-sm'>
              skip
            </Button>
          </div>
        </div>
